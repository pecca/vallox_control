...
const CONFIG_FIELDS: ConfigField[] = [
  {
    ...
    label: 'Start Trigger Level',
    unit: '%',
    min: 50,
    max: 85,
    step: 1,
    description: 'When incoming air efficiency drops to this level, defrost cycle starts',
  },
  {
    key: 'defrost_target_level',
    label: 'Target Recovery Level',
    unit: '%',
    min: 60,
    max: 90,
    step: 1,
    description: 'Efficiency level to reach before stopping defrost (greedy stop with plateau)',
  },
  {
    ...
    max: 2.0,
    step: 0.1,
    description: 'Minimum efficiency gain per check to count as improvement (prevents plateau detection)',
  },
  {
    ...
    max: 10,
    step: 0.5,
    description: 'Safety shutoff: stops heating if DS18B20 exhaust temp drops below this (ice risk)',
  },
  {
    key: 'defrost_fan_stop_no_imp_time',
    label: 'Fan Stop Plateau Timeout',
    unit: 's',
    min: 60,
    max: 600,
    step: 30,
    description: 'Stop fan stop phase if no efficiency improvement for this long (plateau detection)',
  },
  {
    ...
    max: 1800,
    step: 60,
    description: 'Absolute maximum time for fan stop phase (safety timeout)',
  },
  {
    key: 'defrost_stop_duration',
    label: 'Post-Defrost Cooldown',
    unit: 's',
    min: 300,
    max: 1800,
    step: 60,
    description: 'Mandatory cooldown after defrost before next cycle can start (prevents rapid cycling)',
  },
];
