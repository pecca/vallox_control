        ...
        <Table sx={{ minWidth: 650 }} aria-label="defrost cycles table">
          <TableHead sx={{ bgcolor: 'primary.main' }}>
            <TableRow>
              ...
              <TableCell sx={{ fontWeight: 'bold', color: 'common.white' }}>Heating</TableCell>
              <TableCell sx={{ fontWeight: 'bold', color: 'common.white' }}>Fan Stop</TableCell>
          ...
          <TableBody>
            {cycles.map((cycle) => (
              ...
              >
                ...
                <TableCell>
                  <Chip 
                    label={`${Math.round(cycle.heating_duration / 60)} min`} 
                    size="small" 
                ...
                <TableCell>
                  {cycle.fan_stop_duration && cycle.fan_stop_duration > 0 ? (
                    <Chip 
                      label={`${Math.round(cycle.fan_stop_duration / 60)} min`} 
                      size="small" 
                      color="info"
                      variant="outlined"
                    />
