...
<body>
    ...
    if (!$fp) {
        ...
        header("Location: " . $_SERVER['REQUEST_URI']);
        exit();
    } else if (isset($_POST['edit_defrost_fan_stop_max_dur'])) {
    ...
    <table border="1">
        ...
        <tr>
            <td>Average</td>
            <td><?php echo round(($outcoming_air_efficiency_filtered + $incoming_air_efficiency_filtered) / 2, 1) . " %"; ?>
            </td>
        </tr>
    </table>
    ...
    <table border="1">
        ...
        <tr>
            <td>Efficiency improvement threshold</td>
            <td> <?php echo $defrost_eff_imp_thresh . " %"; ?> </td>
            <td>
                <form method="post">
                    <input type="text" name="edit_defrost_eff_imp_thresh_set" size="2" />
                    <input type='submit' name='edit_defrost_eff_imp_thresh' value="Set" />
                </form>
            </td>
        </tr>
        <tr>
            <td>Heating no-improvement timeout</td>
            <td> <?php echo $defrost_heating_no_imp_time . " s"; ?> </td>
            <td>
                <form method="post">
                    <input type="text" name="edit_defrost_heating_no_imp_time_set" size="4" />
                    <input type='submit' name='edit_defrost_heating_no_imp_time' value="Set" />
                </form>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <form method="post">
                    <input type="text" name="edit_defrost_fan_stop_no_imp_time_set" size="4" />
                    <input type='submit' name='edit_defrost_fan_stop_no_imp_time' value="Set" />
                </form>
            </td>
        </tr>
        <tr>
            <td>Fan stop max duration</td>
            <td> <?php echo $defrost_fan_stop_max_dur . " s"; ?> </td>
            <td>
                <form method="post">
