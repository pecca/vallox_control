 ...
 * @brief  Implementation of temperature conversion NTC <-> Celcius 
 */
...
#define NTC_TO_CELCIUS_TABLE_SIZE   256
 
/******************************************************************************
 *  Local variables
 ******************************************************************************/
 
const real32 c_NTC_temperature_conversion_table[NTC_TO_CELCIUS_TABLE_SIZE] = 
{
    -74.0f, 
    -70.0f, 
    -66.0f, 
